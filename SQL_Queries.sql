...
SELECT item_purchased, ROUND(AVG(review_rating::numeri),2) AS "Avg Review Rating"
FROM customer
...
-- Q7) Segment customer into New, Returning, and Loyal based on their total number of previous purchases and 
-- show the count of each segment.
WITH customer_ype AS 
(SELECT customer_id, previous_purchases, CASE WHEN previous_purchase = 1 THEN 'New' 
WHEN previous_purchase BETWEEN 2 AND 10 'Returning' 
